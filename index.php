...
<br/>
<div class="STYLE3" style="margin-left:3px;color: red;"><strong>Latest miRNASNP blog:</strong><br></div>
<div class="STYLE3" style="margin-left:3px;font-size:15px;">
 miRNASNP 2.0 is released. All data is updated based on miRBase 19 and dbSNP V137. Please see details in <a href="http://bioinfo.life.hust.edu.cn/miRNASNP2/index.php" target="_blank">bioinfo.life.hust.edu.cn/miRNASNP2</a>
</div>
<br/>
...
J Gong, Y Tong, HM Zhang, K Wang, T Hu, G Shan, J Sun*, and AY Guo*.&nbsp;&nbsp;&nbsp;&nbsp;Human Mutation 2011;DOI: 10.1002/humu.21641 
 ...
 <div id="options" style="background-image:url(image/backimage.jpg); background-repeat: no-repeat; display:block">
  ...
  <div id="newoption_1" style="margin-left:370px;padding-top:12px;display:none;cursor:pointer" onmouseout="unactive(1)" >
    <a href="theListofRNA.php?species=human&requir=pre"> <img border="0" src="image/newoption1.jpg" />  </a>
  </div>
  </div>
  <div>
  ...
  <div id="newoption_4" style="margin-left:115px; padding-top:5px;display:none;cursor:pointer" onmouseout="unactive(4)">
      <a href="Targets.php"><img border="0" src="image/newoption4.jpg"  /></a>
  </div>
  </div>
  <div>
