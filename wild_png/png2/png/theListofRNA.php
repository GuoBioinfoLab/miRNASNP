...
<div class="content" style="font-family:Arial, Helvetica, sans-serif; font-size:16px">
  ...
  if($terms!="" && preg_match("/mir|miR|rs/",$terms))
   {    $terms=trim($terms);
...
if($miRNA==""&&$acc==""&&$SNP==""&&$chr==""&&$_GET["species"]=="")
{echo "No items found, please check your search term and try again.";
}
...
if($terms1=="")
 ...
 if($terms1=="")
   {if($rowcount1["count(*)"]!=0)
    {echo "<br/><font size='+2'><b>SNPs in human pre-miRNA regions</b></font><br>";
    }
	if($requir=="pre")
   ...
   {
    echo "<br/><font size='+2'><b>miRNAs with SNPs in pre-miRNA flanking regions (-1kb, +1kb)</b></font><br>";
    if($requir=="chr")
...
<br/>  
  <table border="1" style="font-size:14px">
   ...
   <td  style="text-align:center">Allele
   </td>
...
$spacies_genome["chicken"]="WASHUC2";
  ...
  if($requir=="species")
   ...
   echo "<br/><font size='-1'>There are ".$row2["count(*)"]." SNPs in ".$count[$pp]." pre-miRNAs.The SNP data are based on  <a href='http://www.ncbi.nlm.nih.gov/projects/SNP/'/>dbSNP version: 132 </a>.The human genome assembly is ".$spacies_genome[$count[$pp]]." .</font>";
  ?>
