...
if($terms1=="")
 ...
 if($terms1=="")
  ...
  else
   {
    ...
    if($requir=="chr")
	 echo "<p>There are ".$num." pre-miRNAs on human Chromosome ".$chr.". The miRNA data are based on <a href='http://www.mirbase.org/'>miRBase release 16</a>. The human genome assembly is NCBI GRCh37.</p>";
...
$spacies_genome["chicken"]="WASHUC2";
  ...
  if($requir=="species")
   ...
   echo "<p>There are ".$row2["count(*)"]." SNPs in ".$count[$pp]." pre-miRNAs. The SNP data are based on  <a href='http://www.ncbi.nlm.nih.gov/projects/SNP/'/>dbSNP version: 132 </a>. The ".$count[$pp]." genome assembly is ".$spacies_genome[$count[$pp]]." .</p>";
  ?>
